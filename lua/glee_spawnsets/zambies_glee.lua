...
local zambieSpawnSet = {
    ...
    spawns = {
        ...
        {
            hardRandomChance = { 0, 1 },
            name = "zambie_phantomelite",
            prettyName = "An Elite Phantom Zombie",
        ...
        {
            hardRandomChance = { 0, 1 },
            name = "zambie_reanimatorelite",
            prettyName = "An Elite Reanimator Zombie",
            class = "terminator_nextbot_zambiereanimatorelite",
            spawnType = "hunter",
            difficultyCost = { 600, 1000 },
            difficultyNeeded = { 600, 1000 },
            countClass = "terminator_nextbot_zambiereanimatorelite",
            maxCount = { 1 },
            postSpawnedFuncs = nil,
        },
        {
