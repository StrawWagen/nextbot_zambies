...
function ENT:AdditionalInitialize( )
    ...
    for i = 1, ELECT_SFX_N do
        util_PrecacheSound( ELECT_SFX[ i ] )
    end

    self:PrecacheSounds( self.term_LoseEnemySound )
    self:PrecacheSounds( self.term_CallingSound )
    self:PrecacheSounds( self.term_CallingSmallSound )
    self:PrecacheSounds( self.term_FindEnemySound )
    self:PrecacheSounds( self.term_AttackSound )
    self:PrecacheSounds( self.term_AngerSound )
    self:PrecacheSounds( self.term_DamagedSound )
    self:PrecacheSounds( self.term_DieSound )
    self:PrecacheSounds( self.term_JumpSound )
    self:PrecacheSounds( self.IdleLoopingSounds )
    self:PrecacheSounds( self.AngryLoopingSounds )
